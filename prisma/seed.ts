...
async function main() {
  ...
  await prisma.tourPlan.create({
    data: {
      ...
      packageDescription:
        "Experience the rich heritage of India with our Golden Triangle Tour covering Delhi, Agra, and Jaipur.",
      days: 5,
      nights: 4,
  ...
  await prisma.cabPlan.create({
    data: {
      ...
      packageDescription:
        "Comfortable overnight journey from Delhi to Manali in a premium SUV.",
      days: 2,
      nights: 1,
  ...
  await prisma.blog.create({
    data: {
      ...
      content:
        "Rajasthan, the Land of Kings, is synonymous with heroism, royalty and honour. Here are the top 10 places you must visit... (dummy content)",
      adminId: admin.id,
    ...
    data: [
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1564507592209-45579d501d51?auto=format&fit=crop&w=800&q=80",
        category: "monuments",
      },
      {
